...
// Login panel strings (Moodle 5.2+).
$string['loginwelcometitle'] = 'Welcome to your learning platform';
$string['loginwelcomedescription'] = 'Access a world of knowledge with our comprehensive online learning resources, interactive courses, and a supportive community of educators and learners.';
$string['loginpaneltagline'] = 'Empowering education through technology.';
$string['loginstatusers_value'] = '10K+';
$string['loginstatusers'] = 'Active users';
$string['loginstatsites_value'] = '1K+';
$string['loginstatsites'] = 'Courses';
$string['loginstatcountries_value'] = '50+';
$string['loginstatcountries'] = 'Countries';

// Login form strings (Moodle 5.2+).
...
$string['loginstartsignup'] = 'Create an account';
$string['loginseparatoror'] = 'or';
$string['loginwith'] = 'Sign in with {$a}';
