...
$string['messageprovider:studentissues'] = 'Private Student Issues messages';
...
$string['issue_course_lecturer'] = 'Course lecturer';
$string['issue_message_sent'] = 'Your message has been sent to the lecturer.';
$string['issue_open_conversation'] = 'Open conversation';
$string['issue_notification_lecturer_subject'] = 'New Student Issues message in {$a}';
$string['issue_notification_lecturer_body'] = '{$a->student} sent a private course message in {$a->course} about "{$a->title}". The message content is not included in this notification. Open the conversation: {$a->url}';
$string['issue_notification_student_subject'] = 'Your lecturer replied in {$a}';
$string['issue_notification_student_body'] = 'A lecturer replied to your private course message "{$a->title}" in {$a->course}. The reply content is not included in this notification. Open the conversation: {$a->url}';
...
/* ---- Privacy ---- */
$string['privacy:metadata:umat_ai_chat_logs'] = 'AI chat questions and responses.';
$string['privacy:metadata:umat_ai_chat_logs:userid'] = 'The user who used AI chat.';
$string['privacy:metadata:umat_ai_chat_logs:question'] = 'The question sent to the AI assistant.';
$string['privacy:metadata:umat_ai_chat_logs:answer'] = 'The answer returned by the AI assistant.';
$string['privacy:metadata:umat_ai_chat_logs:timecreated'] = 'When the AI chat interaction occurred.';
$string['privacy:metadata:google_gemini_api'] = 'Course questions may be sent to the configured Google Gemini service.';
$string['privacy:metadata:google_gemini_api:question'] = 'The course question sent for AI processing.';
$string['privacy:metadata:umat_ai_issue_conversations'] = 'Private course issue conversations.';
$string['privacy:metadata:umat_ai_issue_conversations:studentid'] = 'The student who owns the conversation.';
$string['privacy:metadata:umat_ai_issue_conversations:title'] = 'The issue title.';
$string['privacy:metadata:umat_ai_issue_conversations:category'] = 'The issue category.';
$string['privacy:metadata:umat_ai_issue_conversations:timecreated'] = 'When the conversation was created.';
$string['privacy:metadata:umat_ai_issue_reports'] = 'Legacy course issue reports retained for safe migration and records.';
$string['privacy:metadata:umat_ai_issue_reports:userid'] = 'The student associated with the legacy report.';
$string['privacy:metadata:umat_ai_issue_reports:topic'] = 'The legacy report title or topic.';
$string['privacy:metadata:umat_ai_issue_reports:description'] = 'The legacy report description.';
$string['privacy:metadata:umat_ai_issue_reports:lecturer_notes'] = 'Private notes retained from the previous workflow.';
$string['privacy:metadata:umat_ai_issue_reports:lecturer_response'] = 'The lecturer response retained from the previous workflow.';
$string['privacy:metadata:umat_ai_issue_reports:timecreated'] = 'When the legacy report was created.';
$string['privacy:metadata:umat_ai_issue_messages'] = 'Messages and receipts in private course issue conversations.';
$string['privacy:metadata:umat_ai_issue_messages:senderid'] = 'The user who sent the message.';
$string['privacy:metadata:umat_ai_issue_messages:body'] = 'The private message body.';
$string['privacy:metadata:umat_ai_issue_messages:timecreated'] = 'When the message was sent.';
$string['privacy:metadata:umat_ai_issue_messages:deliveredat'] = 'When the message became available to its recipient.';
$string['privacy:metadata:umat_ai_issue_messages:viewedat'] = 'When the recipient viewed the message.';
$string['privacy:metadata:umat_ai_activity_log'] = 'Course activity events recorded for analytics and auditing.';
$string['privacy:metadata:umat_ai_activity_log:userid'] = 'The user associated with the activity.';
$string['privacy:metadata:umat_ai_activity_log:event_type'] = 'The type of activity recorded.';
$string['privacy:metadata:umat_ai_activity_log:event_data'] = 'Metadata associated with the activity.';
$string['privacy:metadata:umat_ai_activity_log:timecreated'] = 'When the activity occurred.';
