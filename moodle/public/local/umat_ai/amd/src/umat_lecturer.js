...
var RB = {
  ...
  /* Toggle library view with active tab indicator */
  switchView: function(view){
    document.querySelectorAll('.umat-lib-toggle').forEach(function(b){
      var isActive=b.dataset.libview===view;
      b.classList.toggle('active',isActive);
      b.style.color=isActive?'var(--u-p)':'var(--u-ol)';
      b.style.borderBottomColor=isActive?'var(--u-p)':'transparent';
