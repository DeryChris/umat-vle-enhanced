define(['core/ajax', 'core/str', 'local_umat_ai/chart', 'core/notification'], function(Ajax, Str, Chart, Notification) {
    'use strict';
    ...
    function renderHealthReport(report) {
        ...
        if (btn) {
            btn.addEventListener('click', function() {
                ...
                // Trigger NLQ-like query via AI service
                Ajax.call([{
                    methodname: 'local_umat_ai_query_student_insights',
                    args: {courseid: cid, query: 'Suggest tailored student outreach strategies for struggling students', risklevel: 'at_risk', limit: 10}
                }])[0].done(function(data) {
                    btn.disabled = false;
                    ...
                    if (data && data.ai_insight) {
                        reportEl.innerHTML = escapeHtml(data.ai_insight);
                    }
                }).fail(function() {
                    btn.disabled = false;
                    btn.innerHTML = '<span class="material-symbols-outlined">auto_awesome</span> Ask AI for tailored student outreach strategies';
